...
\begin{tabularx}{\textwidth}{p{3cm}p{4cm}X}
  ...
  2023-04-05 & Juan Moncada,& Final documentation system design updates\\&Aaron Billones,\\&Steven Ramundi,\\&Gillian Ford \\
  \bottomrule
  \end{tabularx}
...
The conveyor subsystem is comprised of:
\begin{itemize}
...
\begin{itemize}
  ...
  \item 2 stepper driver boards
  \item 2 D-shafts
  \item 
  \item 1 steel extrusion frame
  \item 2 tray dropper end-effectors
\end{itemize}
