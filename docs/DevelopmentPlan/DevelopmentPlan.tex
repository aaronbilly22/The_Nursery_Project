...
\begin{table}[hp]
	...
	%%\item Gantry robot- removed as the Gantry was seen to be too complex and require too much precision based on the environmental needs of the project.
	\item End-effector responsible for tray dropping
	\item End-effector responsible for pot dropping
	%%\item End-effector responsible for grabbing -removed as there is no longer a Gantry and there for there will be no need for the end-effector for the grabbing.
	\end{itemize}
