...
//  else
 ...
 // if(distance2_cm < DISTANCE_MAX)
 //   digitalWrite(LED2_PIN, HIGH); // turn on LED
 // else
// digitalWrite(LED2_PIN, LOW);  // turn off LED
    
 //  if(DISTANCE_MAX > distance2_cm && distance2_cm > DISTANCE_MIN)
 //   digitalWrite(LED2_PIN, LOW);// turn on LED
    
//  else
 //   digitalWrite(LED2_PIN, HIGH);// turn off LED 
